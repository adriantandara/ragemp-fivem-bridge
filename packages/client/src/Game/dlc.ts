...
export class GameDlcNs {
  ...
  nullify(unused: number): boolean { return (HasCloudRequestsFinished as any)(unused); }
  ...
  getExtraContentPackHasBeenInstalled(): boolean { return GetExtraContentPackHasBeenInstalled(); } // unverified
  getIsLoadingScreenActive(): boolean { return GetIsLoadingScreenActive(); }
  hasCloudRequestsFinished(unused: number): boolean { return (HasCloudRequestsFinished as any)(unused); }
