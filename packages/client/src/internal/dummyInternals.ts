...
export function initDummyInternals(dummy: DummyMp, dummyType: number, data: Record<string, any> | undefined): DummyInternalsRec {
  return DummyInternals.init(dummy, { dummyType, data: data ?? {} });
}
