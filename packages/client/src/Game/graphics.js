...
export class GameGraphicsNs {
    ...
    drawLight(x, y, z, r, g, b, intensity, radius) {
        DrawLightWithRangeAndShadow(x, y, z, r, g, b, radius ?? 20.0, intensity ?? 1.0, 0);
    }
    ...
    stopParticleFxLooped(ptFxHandle, killImmediate) {
    ...
    removeParticleFx(ptFxHandle, killImmediate) {
    ...
    setParticleFxLoopedColour(ptFxHandle, r, g, b, noMult) {
    ...
    releaseStreamedTextureDict(textureDict) {
    ...
    requestScaleformMovieInstance(scaleformName) {
        return RequestScaleformMovieInstance(scaleformName);
    }
    hasScaleformMovieLoaded(scaleformHandle) {
        return HasScaleformMovieLoaded(scaleformHandle);
    }

    pushScaleformMovieFunction(scaleformHandle, functionName) {
    ...
    drawScaleformMovie(scaleformHandle, x, y, width, height, r, g, b, a, p9) {
        DrawScaleformMovie(scaleformHandle, x, y, width, height, r ?? 255, g ?? 255, b ?? 255, a ?? 255, p9 ?? 0);
    }
    drawScaleformMovieFullscreen(scaleformHandle, r, g, b, a, p5) {
