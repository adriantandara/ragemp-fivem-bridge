...
export class GameReplayNs {
  ...
  isInteriorRenderingDisabled(): boolean { return IsInteriorRenderingDisabled(); }
  resetEditorValues(): void { ResetEditorValues(); }
  continueTransition(): void { ContinueTransition(); }
  isEditorAvailable(): boolean { return IsEditorAvailable(); }
}
