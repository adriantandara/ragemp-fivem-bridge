...
export class GameRecordingNs {
  ...
  saveClip(): boolean { return SaveRecordingClip(); }
  stopThisFrame(): void { StopRecordingThisFrame(); }
  disableRockstarEditorCameraChanges(): void { DisableRockstarEditorCameraChanges(); }
