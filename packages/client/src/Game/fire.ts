...
export class GameFireNs {
  ...
  getPedInsideExplosionArea(explosionType: number, x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, radius: number): number { return Citizen.invokeNative("0x14BA4BA137AF6CEC", Citizen.resultAsInteger(), explosionType, x1, y1, z1, x2, y2, z2, radius); }
  ...
  getEntityInsideExplosionSphere(explosionType: number, x: number, y: number, z: number, radius: number): number { return Citizen.invokeNative("0xB3CD51E3DB86F176", Citizen.resultAsInteger(), explosionType, x, y, z, radius); }
  ...
  getEntityInsideExplosionArea(explosionType: number, x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, radius: number): number { return Citizen.invokeNative("0x14BA4BA137AF6CEC", Citizen.resultAsInteger(), explosionType, x1, y1, z1, x2, y2, z2, radius); }
}
